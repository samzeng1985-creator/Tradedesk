...
#grid(
  ...
  [#text(size: 18pt, weight: "bold")[PROFORMA INVOICE] #h(6pt) #text(size: 8pt, fill: luma(90))[形式发票]],
  [],
)
...
#table(
  ...
  [#nowrap[*BUYER / IMPORTER* #h(4pt) #payload.buyer #h(4pt) #text(fill: luma(70))[#payload.buyerAddress]]],
)
#v(5pt)
#table(
  ...
  [#nowrap[*PI No.*]], [#nowrap[#data.number]], [#nowrap[*Issue Date*]], [#nowrap[#data.issueDate]],
  [#nowrap[*Reference*]], [#nowrap[#data.businessCaseNumber]], [#nowrap[*Customer PO*]], [#nowrap[#payload.poReference]],
