...
#align(center)[
  #text(size: 17pt, weight: "bold")[DETAILED PACKING LIST]
  #linebreak()
  #text(size: 8pt, fill: luma(90))[详细装箱单 / Commercial Packing List]
]
...
#v(12pt)
#align(right)[#box(width: 48mm)[#line(length: 100%)\ Authorized Signature]]
